...
$(function(){   
	...
	columns:[[    
		...
		{field:'creater',title:'用户',sortable:true,width:20},
		{field:'createDate',title:'操作时间',sortable:true,width:20},
	    {field:'operationCode',title:'操作编码',sortable:true,width:40},
	    {field:'requestParam',title:'参数',sortable:true,width:80},
	  	{field:'executeTime',title:'执行时间(mm)',sortable:true,width:20},
	  	{field:'ip',title:'IP',sortable:true,width:20},
	  	{field:'os',title:'操作系统',sortable:true,width:20},
		{field:'browser',title:'浏览器',sortable:true,width:20}
	]],
    headerContextMenu: [
        {
