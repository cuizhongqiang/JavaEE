...
$(function(){   
	dg=$('#dg').datagrid({    
	    ...
	    columns:[[    
	        ...
	        {field:'cronExpression',title:'cron表达式',sortable:true,width:20,editor: "text"},
	        {field:'status',title:'状态',sortable:true,width:20},
	        {field:'className',title:'任务类',sortable:true,width:40},
	        {field:'description',title:'描述',sortable:true,width:30}
	    ]],
	    toolbar:'#tb',
