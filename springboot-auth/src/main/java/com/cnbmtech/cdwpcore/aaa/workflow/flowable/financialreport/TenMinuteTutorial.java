package com.cnbmtech.cdwpcore.aaa.workflow.flowable.financialreport;
...
public class TenMinuteTutorial {
	...
	public static void main(String[] args) {
		...
		repositoryService.createDeployment().addClasspathResource("processes/FinancialReportProcess.bpmn20.xml")
				.deploy();
